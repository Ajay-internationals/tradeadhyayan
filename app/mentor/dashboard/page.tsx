...
export default function MentorDashboardPage() {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6" style={{ backgroundColor: "#F8FAFC" }}>
      {/* Topbar */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          ...
          <div key={idx} className="bg-white p-5 rounded-[22px] border border-[#E9E6F5] shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-[22px] border border-[#E9E6F5] shadow-sm p-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              {/* Column 1: Pending */}
              <div className="bg-[#F8FAFC] rounded-[20px] p-4 border border-[#E9E6F5] flex flex-col h-[300px]">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-[11px] font-bold bg-white border border-[#E9E6F5] text-[#0F172A] px-2 py-0.5 rounded-full shadow-sm">
                ...
                <div className="space-y-3 overflow-y-auto flex-1 pr-1 custom-scrollbar">
                  {data.reviewRequests?.filter((r:any) => r.status === "PENDING").map((req:any) => (
                    <div key={req.id} className="bg-white p-3.5 rounded-[12px] border border-[#E9E6F5] shadow-sm cursor-grab hover:border-[#6D3DF5] transition-colors">
              ...
              <div className="bg-[#F8FAFC] rounded-[20px] p-4 border border-[#E9E6F5] flex flex-col h-[300px]">
                ...
                <div className="flex-1 flex items-center justify-center border-2 border-dashed border-[#E9E6F5] rounded-[12px] bg-white bg-opacity-50">
              ...
              <div className="bg-[#F8FAFC] rounded-[20px] p-4 border border-[#E9E6F5] flex flex-col h-[300px]">
                ...
                <div className="space-y-3 overflow-y-auto flex-1 pr-1 custom-scrollbar">
                  {data.reviewRequests?.filter((r:any) => r.status === "COMPLETED").map((req:any) => (
                    <div key={req.id} className="bg-white p-3.5 rounded-[12px] border border-[#E9E6F5] shadow-sm opacity-70">
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  {data.clients?.map((c:any) => (
                    <tr 
                      key={c.id} 
                      className={`border-b border-[#E9E6F5] last:border-0 hover:bg-slate-50 transition-colors cursor-pointer ${selectedTraderId === c.id ? 'bg-[#F1ECFF]' : ''}`}
        ...
        {selectedTrader && (
          <div className="bg-white rounded-[22px] border border-[#E9E6F5] shadow-sm p-6 flex flex-col h-[calc(100vh-180px)] sticky top-[100px]">
             ...
             <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-[#F8FAFC] rounded-[12px] border border-[#E9E6F5] p-3 text-center">
             ...
             <div className="flex justify-between items-center bg-[#F8FAFC] p-3 rounded-[12px] mb-6">
                ...
                <div className="w-[1px] h-8 bg-[#E9E6F5]"></div>
                <div>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: #E9E6F5; border-radius: 4px; }
      `}} />
    </div>
  );
}
